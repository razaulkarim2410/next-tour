...
const categories = [
  ...
  { name: "Bedding Sets", slug: "bedding-sets", image: "/images/bedding-sets.jpg" },
  { name: "Dry Food", slug: "dry-food", image: "/images/dry-food.jpg" },
  { name: "cosmetics", slug: "cosmetics", image: "/images/cosmetics.jpg" },
];

export default function CategorySection() {
  return (
    <section className="w-11/12 mx-auto py-10">
      <h2 className="text-3xl font-xl  mb-8">Shop by Category</h2>
